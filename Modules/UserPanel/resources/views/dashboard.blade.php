...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold gradient-text">Welcome back, {{ $user->name }}!</h1>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
            ...
            <div class="space-y-3">
                <a href="#" class="flex items-center p-3 text-gray-700 rounded-lg hover:bg-purple-50 transition-colors border border-gray-200 hover:border-purple-200">
                    <i class="fas fa-plus-circle text-purple-500 w-5 h-5 mr-3"></i>
                    <span class="font-medium">Create New Project</span>
                </a>
                <a href="#" class="flex items-center p-3 text-gray-700 rounded-lg hover:bg-green-50 transition-colors border border-gray-200 hover:border-green-200">
                    <i class="fas fa-upload text-green-500 w-5 h-5 mr-3"></i>
                    <span class="font-medium">Upload Files</span>
                </a>
                <a href="{{ route('userpanel.settings') }}" class="flex items-center p-3 text-gray-700 rounded-lg hover:bg-yellow-50 transition-colors border border-gray-200 hover:border-yellow-200">
                    <i class="fas fa-cog text-yellow-500 w-5 h-5 mr-3"></i>
                    <span class="font-medium">Update Profile</span>
                </a>
                <a href="{{ route('userpanel.subscription') }}" class="flex items-center p-3 text-gray-700 rounded-lg hover:bg-purple-50 transition-colors border border-gray-200 hover:border-purple-200">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
        <div class="flex items-center justify-between mb-4">
            ...
            <a href="#" class="text-purple-600 hover:text-purple-700 text-sm font-medium transition-colors">View All</a>
        </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                                <div class="w-8 h-8 bg-purple-100 rounded-lg flex items-center justify-center">
                                    <i class="fas fa-shopping-cart text-purple-600 w-4 h-4"></i>
                                </div>
                                <div class="ml-4">
