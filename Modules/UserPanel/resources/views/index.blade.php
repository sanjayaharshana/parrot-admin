...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-sm p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="{{ route('userpanel.settings') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                <i class="fas fa-cog text-blue-500 w-5 h-5 mr-3"></i>
                <span class="font-medium text-gray-700">Settings</span>
            </a>
            <a href="{{ route('userpanel.subscription') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <a href="#" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                <i class="fas fa-upload text-purple-500 w-5 h-5 mr-3"></i>
