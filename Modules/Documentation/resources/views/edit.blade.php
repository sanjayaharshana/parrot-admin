<x-documentation::layouts.master>
    <div class="max-w-4xl mx-auto">
        <div class="mb-8">
            <h1 class="text-3xl font-bold text-gray-900">Edit Documentation Page</h1>
            <p class="text-gray-600 mt-2">Update the documentation page content and settings.</p>
        </div>

        <div class="bg-white rounded-lg shadow-sm border p-8">
            <form action="{{ route('documentation.update', $page->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="excerpt" id="excerpt" rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Brief description of the page content">{{ old('excerpt', $page->excerpt) }}</textarea>
                        @error('excerpt')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="content" id="content" rows="15" required
                                  ...
                                  placeholder="Enter the page content in HTML format">{{ old('content', $page->content) }}</textarea>
                ...
                <div class="flex justify-between space-x-4 mt-8 pt-6 border-t">
                    <div class="flex space-x-4">
                        ...
                        <form action="{{ route('documentation.destroy', $page->id) }}" method="POST" class="inline" 
