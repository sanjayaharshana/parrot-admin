    ...
    protected function makeResource(): ResourceService
    {
        return (new ResourceService(Products::class, 'products'))
            ...
            ->tab('inventory', 'Inventory & Shipping', 'fa fa-boxes')
                ->section('Physical Inventory', 'fa fa-box')
                ...
                ->section('Digital Delivery', 'fa fa-download')
                    ->text('download_link')
                        ->searchable()
                        ->sortable()
                ...
                ->section('Subscription Access', 'fa fa-user-clock')
            ...
            ->tab('pricing', 'Pricing & Billing', 'fa fa-dollar-sign')
                ->section('Base Pricing', 'fa fa-dollar-sign')
                    ->number('price')
                        ->searchable()
                        ->sortable()
                        ->placeholder('0.00')
                ...
                ->section('Subscription Details', 'fa fa-calendar')
                ...
                ->section('Shipping & Tax', 'fa fa-shipping-fast')
                ...
                ->section('Digital Licensing', 'fa fa-key')
                    ->text('license_key')
                        ->searchable()
                        ->sortable()
            ...
            ->tab('settings', 'Product Settings', 'fa fa-cog')
                ->section('Visibility & Status', 'fa fa-eye')
                    ->switch('is_active')
                        ->searchable()
                        ->sortable()
                ...
                ->section('Product Features', 'fa fa-star')
                    ->switch('is_new')
                        ->searchable()
                        ->sortable()
                        ->label('New Product')
                ...
                ->section('Product Type Settings', 'fa fa-cog')
                ...
                ->section('Display Settings', 'fa fa-sort')
                    ->number('sort_order')
                        ->searchable()
                        ->sortable()
