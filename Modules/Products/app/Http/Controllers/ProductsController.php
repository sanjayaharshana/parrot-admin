...
class ProductsController extends ResourceController
{
    ...
    protected function makeResource(): ResourceService
    {
        return (new ResourceService(Products::class, 'products'))
            ...
            // 1. Basic Information Tab (High Priority - Shows First)
            ...
            ->tab('pricing_inventory', 'Pricing & Inventory', 'fa fa-dollar-sign')
                ->priority('medium')
                ...
                ->section('Inventory & Shipping', 'fa fa-boxes')
            ...
            ->tab('advanced', 'Advanced Settings', 'fa fa-cog')
                ->priority('low')
                ->collapsible()
                ->section('Digital & Subscription', 'fa fa-key')
                    ->text('download_link')
                        ->searchable()
                        ->sortable()
                ...
                ->section('SEO & Marketing', 'fa fa-search')
                    ->text('meta_title')
                        ->searchable()
                        ->sortable()
                ...
                ->section('Additional Information', 'fa fa-plus-circle')
